      ...
      {isSended ? (
        <>
          ...
          <div className=" cart__empty">
            ...
            <p className="cart__empty-caption">
              Your ordering is completely successful
            </p>

            <p className="cart__empty-subCaption">
              We'll let you know when it ships and it headed your way.
            </p>
            <div className="cart__empty-details">
              <p className="cart__empty-details-order">
                {" "}
                <span className="cart__empty-details-order--gray">Order:</span>
                0844253425
              </p>
              <p className="cart__empty-details-date">
                {" "}
                <span className="cart__empty-details-date--gray">
                  Date order:
                </span>
                07/12/20
              </p>
            </div>
            <NavLink className="cart__empty-btn--white btn" to="/home">
              continue shoping
            </NavLink>
          </div>
        </>
          ...
          <div className="cart__content">
            {cartProducts.length !== 0 ? (
              <>
                      ...
                      <div key={el.id} className="cart__item">
                        ...
                        <div className="cart__descr">
                          <div className="cart__name">
                            ...
                            <Close
                              onClick={() => deleteProductFromCart(el)}
                              className="cart__name-close"
                              alt="cross"
                            />
                          </div>
                          <div className="cart__quantity-container">
                            <div className="cart__quantity">
                              ...
                              <div className="cart__quantity-btns">
                                <div className="cart__quantity-less">
                                  <Minus
                                    onClick={() => cutProductFromCart(el)}
                                  />
                                </div>
                                ...
                                <div className="cart__quantity-more">
                                  <Plus onClick={() => addProductToCart(el)} />
                                </div>
                              </div>
                            </div>
                ...
                <div className="cart__summary">
                  ...
                  {cartProducts.map((el) => {
                    ...
                    return (
                      <div key={el.id} className="cart__summary-item">
                        ...
                        <p className="cart__summary-item-price">
                          ${el.counter * el.price}
                        </p>
                      </div>
                    );
                  ...
                  <div className="cart__summary-delivery">
                    <p className="cart__summary-delivery-delivery">
                      Express Delivery
                    </p>
                    <p className="cart__summary-delivery-price">$10</p>
                  </div>
                  <div className="cart__summary-total">
                    <p className="cart__summary-total-capture">
                      Estimated Total
                    </p>
              ...
              <div className=" cart__empty">
                ...
                <NavLink className="cart__empty-btn btn" to="/home">
                  START SHOPPING
                </NavLink>
              </div>
            )}
