    ...
    <>
      {openBurger ? (
        <ul className="burger-menu__list">
          {tempArr.map((el) => (
            <li key={el.id} className="burger-menu__item">
              {" "}
              <NavLink
                onClick={() => setOpenbirger(false)}
                activeClassName="burger-menu__item--pressed"
                to={el.alias}
      ...
      <div className="top-bar__container">
        <div className="top-bar">
            ...
            <ul className="top-bar__list list">
              {tempArr.map((el) => (
                <li key={el.id} className="list__item">
                  ...
                  <NavLink
                    to={el.alias}
                    activeClassName="list__link--pressed"
                    className="list__link"
                  >
                    {el.title}
                  </NavLink>{" "}
          ...
          <div className="top-bar__info">
            <div id="search" className="top-bar__item">
              <NavLink
                className="top-bar__link"
                activeClassName="top-bar__item--pressed"
                to="/search"
              >
                <Search />
              </NavLink>
            ...
            >
              ...
              <NavLink
                activeClassName="top-bar__item--pressed"
                className="top-bar__link top-bar__link--disabled-link"
                to="/card-list"
              >
                <Cart />
                {cartProducts.length}
